...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKnf0bjbsl4mxuece13uy1s3i8e` (`discussion_id`),
  KEY `FKqi14bvepnwtjbbaxm7m4v44yg` (`user_id`),
  CONSTRAINT `FKnf0bjbsl4mxuece13uy1s3i8e` FOREIGN KEY (`discussion_id`) REFERENCES `discussion` (`id`),
...
-- Dump completed on 2024-02-22 19:31:31
